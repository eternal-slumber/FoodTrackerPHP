...
Если не уверен в продукте или не знаешь значения — верни {\"calories\": 0, \"proteins\": 0, \"fats\": 0, \"carbs\": 0}.";
    ...
    private function processingContext(string $processing): string
    {
        ...
        return "У пользователя выбран способ обработки: {$label}. Учитывай его как контекст продукта: например, \"яйца\" + \"варка\" означает варёные яйца. Верни КБЖУ на 100 г уже приготовленного продукта.";
    }
